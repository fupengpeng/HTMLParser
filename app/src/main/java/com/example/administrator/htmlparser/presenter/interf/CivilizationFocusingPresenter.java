...
public class CivilizationFocusingPresenter extends BaseFragmentPresenter implements ICivilizationFocusingPresenter {
    private IFragmentCivilizationFocusing fragment;
    private ICivilizationFocusingModel model;

    public CivilizationFocusingPresenter(IFragmentCivilizationFocusing fragmentCivilizationFocusing) {
        super(fragmentCivilizationFocusing);
        this.fragment = fragmentCivilizationFocusing;
